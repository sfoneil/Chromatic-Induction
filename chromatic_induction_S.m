...
ccDir = pwdj; %'E:\Experiments\Chromatic Induction';
...
bkgdTri = [zeros(size(backgroundContrasts))', ...
    backgroundContrasts', ...
...
for i = 1:size(t,1)
    ...
    mwCurrDot = trival('MW', [0, currContrast, dotLum]);
    ...
    while ~trialEnded
        ...
        mwCurrDot.Value(2) = currContrast;
